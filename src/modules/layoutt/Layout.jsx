...
const LayoutAmado = () => {
  return (
    <>
      ...
      {/* Modal icon search */}
      <div
        className="modal fade h-25 bg-light"
        id="exampleModal1"
        tabIndex={-1}
          ...
          <div className="modal-content rounded-0">
            <div className="modal-header rounded-0">
              <input
                ...
                className="form-control border-0 rounded-0  m-auto  p-3"
              />
              <div className="m-auto">
                <i
                  className="fa-solid fa-x btn btn-warning p-2 ms-3 m-auto rounded-0 float-end"
      ...
      <div className="container-fluid">
        <div className="row w-100 rps_nav_layout_img">
          <Narbarr />
          <Outlet />
        </div>
      </div>
